...
REVISION = 20
FINETUNE_STATUS_BLOCKED = "ml_production_precision_revision20_two_stage_blocked"
FINETUNE_STATUS_SELECTED = "ml_production_precision_revision20_two_stage_selected"


def run_revision20_two_stage(
    inventory_root: Path,
    grouped_root: Path,
    revision9_root: Path,
    ...
    return run_revision14_two_stage(
        ...
        augmentation_boundary_stage1_positive=True,
    )


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run Revision-20 overlap-positive corrected OOF."
    )
    ...
    manifest = run_revision20_two_stage(
        args.inventory,
        args.grouped_data,
        args.revision_9,
        args.augmentation,
